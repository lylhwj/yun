<template>
  <div>
          ...
          <div v-if="isLogin&&!loginIsQr">
            <div v-if="!loginPhoneMethod" class="login_box">
              ...
              <div class="mt20 mb20">
                ...
                <span class="fr"><router-link to="/findPwd">忘记密码</router-link></span>
              </div>
            ...
            <div v-if="loginPhoneMethod" class="login_box">
              ...
              <div class="mt20 inp_yzm">
                <el-input placeholder="动态密码" v-model="loginForm.loginCode" @keyup.enter.native="phoneLogin"></el-input>
                <el-button style="padding:12px 0;" :type="isSendCode?'primary':'info'"  :loading="codeLoading" ref="timeDown" @click="getCode">{{codeMsg}}</el-button>
              </div>
              <div class="mt20 mb20">
                <div v-if="isRegister">
              ...
              <p class="mt20">其它方式：<a href="javascript:;" @click="thirdPartyLogin(1)" class="icon_qq"></a><a href="javascript:;" @click="thirdPartyLogin(2)" class="icon_wx"></a>
    ...
    <div id="JS_bind_phone" class="disn">
      <NeedBindPhone v-if="bindPhoneAlert" :info="infoData"></NeedBindPhone>
...
export default {
  name: "login",
  metaInfo: {
    title: "边乐云,存知己,若比邻", // set a title
    meta: [
      {
        name: "keywords",
        content: "网盘,云盘,边乐云网盘,边乐云云盘"
      },
      {
        name: "description",
        content:
          "边乐云网盘致力于为用户提供安全稳定的云存储产品，边乐云盘可将相册、视频、短信、通讯录、通话记录一键备份到云端。更有极速云下载、高清云预览等功能!"
      }
    ]
  },
  data() {
...
@media (max-height: 800px) {
  ...
  .layout-frame body.scrollx-hidden {
    overflow-y: hidden;
  } 
}
</style>
