        ...
        <div class="view_box2"> 
          <div class="pan_top">
            <p class="flex" style=" height:36px;">
              ...
              <i class="icon_fav"></i><span class="lineh30 f16 gray">收藏标签：{{favoritesTitlte}}</span>
            </p>
          </div><!-- pan头部 -->
          <div class="pan_head">
            <!-- <div class="fl">
                          ...
                          <div v-if="scope.row.resource.source==1">
                            ...
                            <span v-else-if="scope.row.resource.pass">
                              ...
                              <a href="javascript:;" v-else-if="scope.row.resource.jindu?scope.row.resource.jindu.jindu=='100':false"
                                ...
                                <span v-if="scope.row.resource.pass" class="type_txt_pass"></span>
                            ...
                            <span v-else>
                              ...
                              <a href="javascript:;" v-else-if="scope.row.resource.jindu?scope.row.resource.jindu.jindu=='100':false"
                                @click="openLixian2(scope.row.resource)"><span class="type_yes"></span></a>
                              <a href="javascript:;" v-else @click="openLixian2(scope.row.resource)"><span
...
<style>
.search_tab.search_tab_fav .el-tabs__item.is-active:before { background:url(../assets/icon_new.svg) no-repeat -140px -60px; }
.icon_fav { display:inline-block; width:20px; height:30px; margin:1px 10px 1px 15px; background:url(../assets/icon_new.svg) -140px -100px; }
.icon-video {
  width: 64px;
  height: 64px;
  display: block;
